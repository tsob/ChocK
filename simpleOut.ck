...
// @desc Same as simple.ck but outputs 4 wav files
...
10 * updateTime => int minIOI; //in ms
80 * updateTime => int maxIOI; //in ms

5.0 => float attraction; // attraction factor


// writing signals to files...
dac.chan(0) => WvOut out1 => blackhole;
dac.chan(1) => WvOut out2 => blackhole;
dac.chan(2) => WvOut out3 => blackhole;
dac.chan(3) => WvOut out4 => blackhole;
me.sourceDir() + "/1_output.wav" => string _capture1;
me.sourceDir() + "/2_output.wav" => string _capture2;
me.sourceDir() + "/3_output.wav" => string _capture3;
me.sourceDir() + "/4_output.wav" => string _capture4;
_capture1 => out1.wavFilename;
_capture2 => out2.wavFilename;
_capture3 => out3.wavFilename;
_capture4 => out4.wavFilename;
